...
WITH new_fact_transactions AS (
    ...
    FROM 
        {{ source('raw_snowflake', 'fact_transactions') }}
)
...
FROM 
    ...
    {{ inner_join_id("raw_snowflake", "dim_customers", "transaction", "customer", "customer_id", "customer_id") }}
    {{ inner_join_id("raw_snowflake", "dim_dates", "transaction", "date", "txn_date_id", "date_id") }}
    {{ inner_join_id("raw_snowflake", "dim_channels", "transaction", "channel", "channel_id", "channel_id") }}
    {{ inner_join_id("raw_snowflake", "dim_accounts", "transaction", "account", "account_id", "account_id") }}
    {{ inner_join_id("raw_snowflake", "dim_transaction_types", "transaction", "transaction_type", "txn_type_id", "transaction_type_id") }}
    {{ inner_join_id("raw_snowflake", "dim_locations", "transaction", "location", "location_id", "location_id") }}
    {{ inner_join_id("raw_snowflake", "dim_currencies", "transaction", "currency", "currency_id", "currency_id") }}
    {{ inner_join_id("raw_snowflake", "dim_loans", "transaction", "loan", "loan_id", "loan_id") }}
    {{ inner_join_id("raw_snowflake", "dim_investment_types", "transaction", "investment_type", "investment_type_id", "investment_type_id") }}
